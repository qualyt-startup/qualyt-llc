...
# Step 3: Update Environment Variables in .env for MongoDB URI with Provided Credentials
echo "PORT=3000" > .env
echo "MONGO_URI=mongodb+srv://qualytsolutionsgroup@gmail.com:D@nnY@420@cluster.mongodb.net/<dbname>?retryWrites=true&w=majority" >> .env
